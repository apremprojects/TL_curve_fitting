...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // double *()(_Bool, int, int, double, double, double, int, double *, double *, double *, size_t)
...
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // double *
...
static double * _cffi_d_solve(_Bool x0, int x1, int x2, double x3, double x4, double x5, int x6, double * x7, double * x8, double * x9, size_t x10)
{
  return solve(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_solve(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "solve", 11, 11, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = solve(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10); }
  _cffi_save_errno();
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_cpp_differential_evolution(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_cpp_differential_evolution(void) { return NULL; }
#  else
     initcpp_differential_evolution(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_cpp_differential_evolution(void)
{
  return _cffi_init("cpp_differential_evolution", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initcpp_differential_evolution(void)
{
  _cffi_init("cpp_differential_evolution", 0x2601, &_cffi_type_context);
}
#endif
